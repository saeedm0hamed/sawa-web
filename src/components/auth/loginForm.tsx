  ...
  return (
    <Card className='w-full bg-transparent border-none shadow-none p-0'>
      ...
      <CardHeader className='text-center p-0 gap-2'>
        <CardTitle className='text-lg md:text-xl lg:text-2xl font-bold'>مرحباً بك مرة أخرى</CardTitle>
      ...
      <CardContent className='p-0 space-y-3'>
        ...
        <div className='text-center space-y-3'>
          <Link href='/reset-password' className='text-sm text-primary hover:underline transition-colors'>
            نسيت كلمة المرور؟
          </Link>
